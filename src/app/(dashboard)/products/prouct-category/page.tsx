...
import { ProductCategory, ProductDescription, ProductImages, ProductPricing, ProductInventory, ProductShipping, Regions } from '@/components/productUpload'
  ...
  return (
    <div  className='flex flex-col items-start justify-start xl:gap-16 lg:gap-12 gap-8 w-full h-full font-barlow'>
        <div className='flex flex-col items-start justify-normal w-full'>
            <h2 className='xl:text-3xl lg:text-2xl text-xl font-semibold text-[#464255]'>Product upload</h2>
            <p className="xl:text-lg lg:text-base text-sm font-normal text-[#a3a3a3]">Upload products to the website for customers to buy</p>
        </div>
            ...
            <div className='flex flex-col lg:gap-11 md:gap-8 gap-5 mxl:basis-1/2 basis-full w-full'>
              ...
              <Regions />
                <Button 
                  type='submit' 
                  children="Discard"
                  className="w-full text-primary_100 hover:bg-primary_100 border border-primary_100 hover:border-white hover:text-white font-barlow xl:text-2xl md:text-xl text-lg font-medium xl:py-7 lg:py-5 md:py-4 py-3" />
